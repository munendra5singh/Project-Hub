...
function generateDynamicQuestion(subKey, diff, num) {
    ...
    return {
        num: num,
        difficulty: diff,
        q: `Q${num}. [${diffText} Level] Which of the following academic statements regarding ${topic} is correct?`,
        options: [
            `Option A: Standard textbook principles and verified academic models of ${topic} fully apply.`,
            `Option B: This concept is restricted exclusively to short-term cyclical phenomena.`,
            `Option C: No qualitative or quantitative evaluation can be derived from this model.`,
            `Option D: None of the above.`
        ],
        correct: 0,
        why: `Option A is correct. Under the B.A. 5th Semester syllabus, ${topic} is evaluated according to verified academic principles as outlined in Option A.`
    };
}
