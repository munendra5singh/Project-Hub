            ...
            resumeContainer.innerHTML = `
                <div class="resume-reading-banner">
                    <div>
                        ...
                        <span>Continue reading: <strong>${lastReading.title}</strong></span>
                    </div>
...
function initGlobalSearch() {
    ...
    searchInput.addEventListener('input', (e) => {
        ...
        if (query.length < 2) {
            resultsContainer.innerHTML = '<li class="p-4 text-center text-subtle text-sm">Type at least 2 characters to search...</li>';
            return;
        }
        ...
        if (filtered.length === 0) {
            resultsContainer.innerHTML = '<li class="p-4 text-center text-subtle text-sm">No topics found matching your search.</li>';
            return;
        }
