            ...
            resumeContainer.innerHTML = `
                <div class="resume-reading-banner">
                    <div>
                        ...
                        <span>पढ़ना जारी रखें: <strong>${lastReading.title}</strong></span>
                    </div>
...
const subjectTitles = {
    ...
    'eco-elective-2': 'अर्थशास्त्र ऐच्छिक 2 — मुद्रा एवं बैंकिंग',
    'eco-elective-3': 'अर्थशास्त्र ऐच्छिक 3 — पर्यावरणीय अर्थशास्त्र',
    'eco-skill': 'अर्थशास्त्र कौशल पाठ्यक्रम — डेटा विश्लेषण',
    'geo-theory': 'भूगोल सिद्धांत (थ्योरी)',
    'geo-practical': 'भूगोल प्रायोगिक (प्रैक्टिकल)',
...
function initGlobalSearch() {
    ...
    searchInput.addEventListener('input', (e) => {
        ...
        if (query.length < 2) {
            resultsContainer.innerHTML = '<li class="p-4 text-center text-subtle text-sm">खोजने के लिए कम से कम 2 अक्षर टाइप करें...</li>';
            return;
        }
        ...
        if (filtered.length === 0) {
            resultsContainer.innerHTML = '<li class="p-4 text-center text-subtle text-sm">आपकी खोज से मेल खाता हुआ कोई विषय नहीं मिला।</li>';
            return;
        }
